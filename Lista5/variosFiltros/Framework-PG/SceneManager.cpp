...
void SceneManager::setupScene()
{
	...
	obj->setPosition(glm::vec3(100, 300.0f, 0.0));
	...
	//Segundo objeto
	obj = new Sprite;
	obj->setPosition(glm::vec3(300, 300.0f, 0.0));
	obj->setDimension(glm::vec3(200.0f, 200.0f, 1.0f)); //note que depois podemos reescalar conforme tamanho da sprite
	...
	//Terceiro objeto
	obj = new Sprite;
	obj->setPosition(glm::vec3(500, 300.0f, 0.0));
	obj->setDimension(glm::vec3(200.0f, 200.0f, 1.0f)); //note que depois podemos reescalar conforme tamanho da sprite
	...
	//Terceiro objeto
	obj = new Sprite;
	obj->setPosition(glm::vec3(700, 300.0f, 0.0));
	obj->setDimension(glm::vec3(200.0f, 200.0f, 1.0f)); //note que depois podemos reescalar conforme tamanho da sprite

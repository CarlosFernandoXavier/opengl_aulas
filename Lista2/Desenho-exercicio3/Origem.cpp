#include <../../Lista2/Desenho-exercicio3/Shader.h>
...
int setupGeometry()
{
	...
	GLfloat vertices[] = {
			300.0f,  300.0f, 0.0f, 1.0, 0.0, 0.0, //Superior esquerdo
			300.0f,  0.0f,   0.0f, 0.0, 1.0, 0.0, //Inferior esquerdo
		    600.0f,  0.0f,   0.0f, 0.0, 0.0, 1.0, //Superior esquerdo


			600.0f,  0.0f, 0.0f, 1.0, 1.0, 0.0,
		    600.0f,  300.0f, 0.0, 1.0, 0.0, 1.0,  //Inferior esquerdo
		    300.0f,  300.0f, 0.0f, 0.0, 1.0, 1.0
	};
